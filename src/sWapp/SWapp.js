    ...
    render() {
        ...
        return (
            ...
            <Switch>
                ...
                <Route path="/films/:uuid" render={() => <Films getUser={this.getUser} user={this.props.user} films={this.props.user.films} />} />
            </Switch>
            </div>
        )
    }
...
export default connect(mapStateToProps, mapDispachToProps)(withRouter(SWapp));
